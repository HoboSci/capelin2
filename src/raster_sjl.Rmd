...
```{r}
obs <- read.csv("../data/observations3.csv") #change this path to your .csv location
head(obs)
```
...
```{r}
test15 <- extract(x=rasbr_aea[[15]], y = obssp)
test22 <- extract(x=rasbr_aea[[22]], y = obssp)
test17 <- extract(x=rasbr_aea[[17]], y = obssp)
test17
```
