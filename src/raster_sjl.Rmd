...
```{r}
data_aea <- read.csv("../data/observations3.csv", header = TRUE) #change this path to your .csv location
xy <- data_aea[ ,c(4,5)] # This is to tell R where the coordinates are (in column 4 and 5). Note that the column order needs to be longitude, latitude
...
#core_cluster <- makeCluster(no_cores)
