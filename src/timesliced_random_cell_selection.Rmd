...
First you need to create columns for the data to be added to
...
XXXXXXXXXXX split
```{r}
background_all2 <- background_all[background_all$year == 1999, ]
...
write.csv(background_all_sp, "../output/bio/background_complete_1999.csv", row.names = FALSE)
