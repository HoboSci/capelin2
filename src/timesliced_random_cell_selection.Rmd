...
```{r}
background_all2 <- subset(background_all[1:6, ])
xy <- background_all2[ ,c(7,8)] # This is to tell R where the coordinates are (in column 18 and 19). Note that the column order needs to be longitude, latitude
