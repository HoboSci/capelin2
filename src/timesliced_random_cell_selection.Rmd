...
for(i in 1:length(rand_list)){
  ...
  randtemp$year <- substr(rand_list[i], 1, 4)
  randtemp$month <- substr(rand_list[i], 6, 7)
...
ok now you can start to populate the rest of the background point information. The background points file should mirror as much as possible the occurence file 
