...
```{r}
bck10000points_2d <- plot(x= testbk10000$longitude_, y = testbk10000$latitude_m)
dev.copy(png,"../data/env/background_point_check/bck10000points_2d.png") # to automatically save the plot to a png AND show it inline
dev.off() # stops automatic saving of the plot to a png
```