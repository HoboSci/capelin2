$sourcepred="C:\Users\bunny\Documents\GitHub\Chapter_1\output\maxent\predictions\test-comb\mar" #location of starting directory - needs changing
$destcyg = "C:\cygwin64\home\bunny"; #location where files will be copied to
$filterclog = "cloglog_st201003.asc" #CHANGE ME
