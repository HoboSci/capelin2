...
loop creating layer stacks
```{r}
jan98_86.9 <- stack(list.files("../data/jan_test_86.9", pattern = glob2rx("*1998_01*_86.9294*.asc"), full.names = TRUE))    # this folder currently contains other dummy files. its just a test to automate stacks
names(jan98_86.9) # now need to rename to match maxent expectations
names(jan98_86.9) <- (pattern = "*chl_surface*" paste0("chl_surface"))
```
