...
dev.copy(png, "../output/env/simple_plots/background_corr.png") # to automatically save the plot to a png AND show it inline
backpairs <- pairs(background_env)
dev.copy(png, "../output/env/simple_plots/background_corr.png") # to automatically save the plot to a png AND show it inline
dev.off() # stops automatic saving of the plot to a png
```
...
png("../output/env/simple_plots/presence_corr.png") # to automatically save the plot to a png AND show it inline
pairs(pres_env)
dev.off() # stops automatic saving of the plot to a png
```
