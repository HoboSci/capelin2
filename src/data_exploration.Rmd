...
dunn test (not working)
```{r}
gear_temp_depthdunn <- dunnTest(presence$temp_depth, presence$gear)

write.csv(gear_temp_depthdunn, "../output/env/gear_temp_depthdunn.csv", row.names = TRUE)
```
