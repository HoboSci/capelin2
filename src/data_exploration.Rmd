...
asclist <- stack(list.files("../data/jan_test_86.9", pattern = glob2rx("*1998_01*_86.9294*.asc"), full.names = TRUE))    # this folder currently contains other dummy files. its just a test to automate stacks
