...
writeRaster(nstk, "../output/maxent/predictions/testplots/nstk.nc", overwrite = TRUE, format = "CDF", varname = "prob", varunit = "p", longname = "dummy netcdf for hovmollers", xname= "X", yname = "Y", zname = "depth", zunit = "m")
```
