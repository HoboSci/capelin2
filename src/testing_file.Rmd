...
test <- read.csv(kapd[1])
test <- subset(test, Probability == 1) #just keep the presence cells
test <- test[order(test[, 1]),] #order by depth 
#now need to find the row in which a value first appears in prob_bin column
