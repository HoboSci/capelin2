...
pstack <- stack(pras6, pras180, pras370, pras697, pras1, pras2, pras3, pras4) #stack the layers
...
p <- levelplot(pstack, ylab = NULL, xlab = NULL, scales=list(draw=FALSE), colorkey=list(space="bottom", at = my.at), par.settings = mapTheme, layout = c(4, 2), names.attr = c("6m", "180m", "370m", "697m", "", "", "", ""))
p + layer(sp.polygons(s, fill = "black")) + layer (sp.polygons(outsidemcp, fill = redtrans, col = NA))

png("../output/maxent/predictions/testplots/rasterVis.png", height = 1024 * 0.707, width = 1024)
p
dev.off()
