...
## XXX SAM THIS IS THE CODE THAT NEEDS EDITING - I THINK JUST REMOVE THE LINE #
...
randbckoutput <- "../output/bio/background/rand20k/" #where the files are to be saved to
# read in each .csv file in file_list and create a data frame with the same name as the .csv file
for (i in 1:length(bckrnd_list)){
  sel <- read.csv(paste(bckrnd_folder, bckrnd_list[i], sep=''))
  sel <- sample_n(sel, 10000) #where 20000 = number of rows to sample (more than 10k as some points will have NA values due to depth - I will select 10000 of these without NA values to create a large sample as per maxent)
...
```{r}
rand_folder <- "../output/bio/background/rand20k/"      # path to folder that holds multiple .csv files
...
rename
longitude_ to longitude_meters
latitude_m to latitude_meters
decimalLon to decimalLongitude
decimalLat to decimalLatitude

```{r}
background_all <- subset(background_all, select = -c(optional, FID))
names(background_all)[names(background_all)=="longitude_"] <- "longitude_meters"
names(background_all)[names(background_all)=="latitude_m"] <- "latitude_meters"
names(background_all)[names(background_all)=="decimalLon"] <- "decimalLongitude"
names(background_all)[names(background_all)=="decimalLat"] <- "decimalLatitude"
head(background_all)
```
...
write.csv(background_all_sp, "../output/bio/background_complete_1999.7.csv", row.names = FALSE)
...
# remove rows with NA values at depth

first rbind... (this you can delete if you had run the code at once)
```{r}
back1998 <- read.csv("../output/bio/background/correct_random_files/background_complete_1998.csv", header = TRUE)
back1999 <- read.csv("../output/bio/background/correct_random_files/background_complete_1999.csv", header = TRUE)
back2000 <- read.csv("../output/bio/background/correct_random_files/background_complete_2000.csv", header = TRUE)
back2001 <- read.csv("../output/bio/background/correct_random_files/background_complete_2001.csv", header = TRUE)
back2002 <- read.csv("../output/bio/background/correct_random_files/background_complete_2002.csv", header = TRUE)
back2003 <- read.csv("../output/bio/background/correct_random_files/background_complete_2003.csv", header = TRUE)
back2004 <- read.csv("../output/bio/background/correct_random_files/background_complete_2004.csv", header = TRUE)
back2005 <- read.csv("../output/bio/background/correct_random_files/background_complete_2005.csv", header = TRUE)
back2006 <- read.csv("../output/bio/background/correct_random_files/background_complete_2006.csv", header = TRUE)
back2007 <- read.csv("../output/bio/background_complete_2007.csv", header = TRUE)
back2008 <- read.csv("../output/bio/background_complete_2008.csv", header = TRUE)
back2009 <- read.csv("../output/bio/background_complete_2009.csv", header = TRUE)
back2010 <- read.csv("../output/bio/background_complete_2010.csv", header = TRUE)
back2011 <- read.csv("../output/bio/background_complete_2011.csv", header = TRUE)
back2012 <- read.csv("../output/bio/background_complete_2012.csv", header = TRUE)
back2013 <- read.csv("../output/bio/background_complete_2013v2.csv", header = TRUE)
back2014 <- read.csv("../output/bio/background_complete_2014.csv", header = TRUE)
back2015 <- read.csv("../output/bio/background_complete_2015.csv", header = TRUE)


background_all <- rbind(back1998, back1999, back2000, back2001, back2002, back2003, back2004, back2005, back2006, back2007, back2008, back2009, back2010, back2011, back2012, back2013, back2014, back2015)
head(background_all)
write.csv(background_all, "../output/bio/background_all_complete.csv", row.names = FALSE)
```
...
```{r}
#back1 <- read.csv("../output/bio/background/rand20k/no_na_10krand/1999.1.csv", header = TRUE)
#back2 <- read.csv("../output/bio/background/rand20k/no_na_10krand/1999.2.csv", header = TRUE)
back3 <- read.csv("../output/bio/background/rand20k/no_na_10krand/1999.3.csv", header = TRUE)
back4 <- read.csv("../output/bio/background/rand20k/no_na_10krand/1999.4.csv", header = TRUE)
back5 <- read.csv("../output/bio/background/rand20k/no_na_10krand/1999.5.csv", header = TRUE)
back6 <- read.csv("../output/bio/background/rand20k/no_na_10krand/1999.6.csv", header = TRUE)
back7 <- read.csv("../output/bio/background_complete_1999.7.csv", header = TRUE)
#back8 <- read.csv("../output/bio/background/rand20k/no_na_10krand/1999.8.csv", header = TRUE)
back9 <- read.csv("../output/bio/background/rand20k/no_na_10krand/1999.9.csv", header = TRUE)
back10 <- read.csv("../output/bio/background/rand20k/no_na_10krand/1999.10.csv", header = TRUE)
back11 <- read.csv("../output/bio/background/rand20k/no_na_10krand/1999.11.csv", header = TRUE)
back12 <- read.csv("../output/bio/background/rand20k/no_na_10krand/1999.12.csv", header = TRUE)

back1998 <- rbind(back3, back4, back5, back6, back7, back9, back10, back11, back12)
#back1998 <- rbind(back1, back2, back3, back4, back5, back6, back7, back8, back9, back10, back11, back12)
write.csv(back1998, "../output/bio/background/correct_random_files/background_complete_1999.csv", row.names = FALSE)
```
...
remove all na values THIS CAN BE EDITED TO DOUBLE CHECK FOR NA VALUES
...
XXX THIS NEEDS EDITING AND MOVING TOO XXXX

```{r}
filenames  <- list.files(path = randbckoutput, pattern="*.csv", full.names = TRUE) 
background_all <- rbindlist(lapply(filenames,fread, fill = TRUE))
write.csv(background_all, "../output/bio/background_all_complete_na2.csv", row.names = FALSE)
head(background_all)
```
...
```{r}
comback <- read.csv("../output/bio/background_complete_obs_cels.csv", header = TRUE)
backtempna <- subset(comback, is.na(comback$temp_depth))
backtempna
backtempnasplit <- split(backtempna, list(backtempna$year, backtempna$month), drop = TRUE)
```
