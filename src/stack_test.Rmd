...
for (td in 1:nrow(unlayer)){
  ...
  test <- stack(temp_depth, chl_surface, o2_depth, salinity_depth, nao_sample, nao_winter)
  #stackSave(test,unlayer$stackname[td])
  pred <- predict(mod1, test, file = paste0("../output/maxentpredict/", stackn, ".asc"), overwrite=TRUE) #sam you just added.asc but have not tested
  paste("maxplot_", stackn, ".png", sep = "") # to automatically save the plot to a png AND show it inline
  preplot <- plot(pred, png(paste0("../output/maxentpredict/", stackn, ".png")))
  dev.off() # stops automatic saving of the plot to a png
}
...
mod7 <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4")) #threads should speed things up...
mod7
...
mod8.1 <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "betamultiplier=0.25")) #playing with multiplier
mod8.1
...
mod8 <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4")) #default setting for betam is 1
mod8
...
mod8.4 <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "betamultiplier=1.25")) #playing with multiplier
mod8.4
...
mod8.2 <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "betamultiplier=2")) 
mod8.2
...
mod8.3 <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "betamultiplier=6")) 
mod8.3
...
mod9 <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30")) 
mod9
...
mod10 <- maxent(x = subpresaball, p = subpaall, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30")) 
mod10
...
mod11 <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "replicates=10")) #replicates added
mod11
...
mod12 <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "addsamplestobackground=TRUE")) #add to samples because field study with biased data - see https://esajournals.onlinelibrary.wiley.com/doi/10.1890/10-1171.1. note this should be the default but keep here as a note
mod12
...
mod1all <- maxent(x = janpresaball, p = paall, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4")) 
mod1all
...
betamval <- 0.25
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=0.25"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 0.50
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=0.50"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 0.75
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=0.75"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 1
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=1"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 1.25
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=1.25"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 1.50
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=1.50"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 1.75
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=1.75"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 2
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=2"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 2.25
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=2.25"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 2.50
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=2.50"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 2.75
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=2.75"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 3
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=3"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 3.25
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=3.25"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 3.50
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=3.50"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 3.75
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=3.75"), path = "../output/maxent/output/mod9foraic") 
...
betamval <- 4
modaic <- maxent(x = prab, p = pa, args=c("maximumiterations=5000", "responsecurves=TRUE", "jackknife=TRUE", "threads=4", "randomtestpoints=30", "betamultiplier=4"), path = "../output/maxent/output/mod9foraic") 
