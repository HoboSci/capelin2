...
asclayerall <- crossing(ascyears, ascmonths)
asclayerall$stackname <- paste0("st", asclayerall$ascyears, asclayerall$ascmonths) #this creates the name of the stack that will be used
...
myr <- 2014 #!!!!!!  CHANGE ASCNAME, ASCPATH AND CSV FILE NAME

asclayer <- subset(asclayerall, ascyears == myr)
