...
```{r}
plot(cell_layer)
plot(spatial_data_aea$decimalLatitude, spatial_data_aea$decimalLongitude)
plot(spatial_data$decimalLongitude,spatial_data$decimalLatitude)
```
oh it doesn;t work... it should be in meters now?
