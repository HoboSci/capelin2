...
first make sure that the data_aea$depth without values == NA (currently they are marked xx)
```{r}
...
```{r}
data_aea$depth <- as.numeric(as.character(data_aea$depth))
str(data_aea)
```
...
The warm/cold year index will be taken from a [DFO CSAS report](http://www.dfo-mpo.gc.ca/csas-sccs/Publications/SAR-AS/2018/2018_039-eng.pdf)
