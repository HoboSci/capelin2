...
packages <- c("packrat", "rworldmap", "dplyr","plyr", "rgdal", "sp",)
source("../src/ipak.R")
ipak(packages)
...
# see who sampled in which year

```{r}
with(adddata, table(year, institutioncode))
write.csv(obs_by_ins, file = "../output/bio/institutioncode_by_yr.csv")
```


# createa unique cell ID
