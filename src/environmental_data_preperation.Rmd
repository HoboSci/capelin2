...
writeRaster(aea,'../data/env/aea.tif',options=c('TFW=YES'))
plot(aea[[36]]) #the number in brackets refers to the depth number

m <- spTransform(rnaturalearth::ne_countries(), prj)
```

>>>>>>> 70371c3f9a3e5693038dc7cfecc846d17e51933f
