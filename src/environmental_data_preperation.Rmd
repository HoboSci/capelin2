...
writeOGR(uniquecell_poly, dsn = '.', layer = '../output/env/poly', driver = "ESRI Shapefile")
...
```{r}
library("ncdf4")
biobrick <- brick("../data/env/CMEMS_GLOBAL_REANALYSIS_BIO_001_018_chl_monthly_mean_1998-01.ncwgs.nc_lonlat.ncdepthtrim.nc") # lvar = 4 
biobrick
```
