  ...
  for (h in 1:nrow(betavallist)){
   ...
   #test auc scores and other lovely things you might want to include
    ...
    if(aicetc$regularization[i] == betaval){
      ...
      aicetc$test_coefficients[i] <- nocoeff
      aicetc$test_sum.of.logs[i] <- sumsamplepred
...
for (year in 1:nrow(modelmonth)){
  ...
  if (yr == "2001" | yr == "2006" | yr == "2007"){
    betaval <- 1.75
  } else if (yr == "2000"| yr == "2002" | yr == "2003" | yr == "2004"){
    betaval <- 2
  } else if (yr == "1999" | yr == "2005" | yr == "2008" | yr == "2009"){
    betaval <- 2.25
  } else if (yr == "2010" | yr == "2011"){
    betaval <- 2.5
  } else if (yr == "1998"){
    betaval <- 2.75
  }
