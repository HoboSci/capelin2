...
packages <- c("dismo", "stringr", "rJava")
source("../src/ipak.R")
ipak(packages)
```
...
for (year in 1:nrow(modelmonth)){
  ...
  if (timeslice == "mar2003"){
    betaval <- 1
  } else if (timeslice == "mar1999"| timeslice == "mar2002" | timeslice == "mar2008" | timeslice == "mar2009"){
    betaval <- 1.25
  } else if (timeslice == "mar2005" | timeslice == "mar2006"){
    betaval <- 1.5
  } else if (timeslice == "mar2000"){
    betaval <- 1.75
  } else if (timeslice == "mar2001" | timeslice == "mar2007"){
    betaval <- 2.25
  } else if (timeslice == "mar2010"){
    betaval <- 3.5
  }
...
avg <- calc(stkasc, fun = mean)
  writeRaster(avg, (paste0("../output/maxent/predictions/", mthna, "/avg_", mthna, ".asc")), overwrite=TRUE)
  avgplot <- plot(avg, png(paste0("../output/maxent/predictions/", mthna, "/avg_", mthna, ".png"))) 
  dev.off()
